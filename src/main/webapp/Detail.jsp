            ...
            <div class="col-md-6">
              <div class="product-dtl">
                ...
                <p>Chất liệu vải rất dễ vệ sinh rất mềm và không có mùi
                    ...
                    - Thiết kế cá tính 
                    -  Đế cao su trong chống trơn trượt
                    - Size từ 35-40
                    𝐌𝐎̂ 𝐓𝐀̉ 𝐒𝐀̉𝐍 𝐏𝐇𝐀̂̉𝐌 𝐂𝐇𝐈 𝐓𝐈𝐄̂́𝐓
                    - Phần thân trên
                    vải canvas mềm mịn cao cấp đi rất êm chân, mang thoải mái đi lại cả ngày 
                    - Phần Midsole (đế giữa)  lót E.VA êm ái
                    - Phần Outsole (đế ngoài) là điểm quyết định của em giày sandal này. Đế cao su đặc có độ bám dính, chống trơn trượt, ma sát tối đa, tạo độ êm ái thoải mái nên sản phẩm hết sức tuyệt vời cho những cô nàng có tính chất công việc phải đi lại cả ngày.</p>
                <div class="row">
                  <div class="col-md-6">
              ...
              <a href="#" class="round-black-btn">Thêm Vào Giỏ <i class="fa fa-cart-plus" aria-hidden="true"></i></a>
              <a href="#" class="round-black-btn">Mua Ngay  <i class="fa fa-money" aria-hidden="true"></i></a>
                </div>
              </div>
            </div>
          </div>
          <div class="shop_owner" >
            <div class="decoration_shop">
                <div class="avatar_shop">
                    <img src="https://cf.shopee.vn/file/a46098c1b5d42fbd59b548dac95d0d8a_tn" alt="" style="border-radius: 50%; border: 2px solid #777777; width: 80px; margin: 20px;">
                </div>
                <div class="set_shop">
                    <div class="name_shop">
                        <h2 style="margin: 10px; padding: 0;">CELLPHONE.VN</h2>
                    </div>
                    <div class="button_shop">
                        <button style="background-color: #FF9966; color:#ee4d2d ;">CHAT NGAY <i class="fa fa-commenting" aria-hidden="true"></i></button>
                        <button style="background-color: #FFFF; color: #777777;">GHÉ THĂM <i class="fa fa-home" aria-hidden="true"></i></button>
                    </div>
                </div>
            </div>
            <div class="status_shop">
                <p>Đánh giá <span>74.6K</span></p>
                <p>Tỉ lệ phản hồi <span>94.4%</span></p>
                <p>Số người theo dõi <span>148.4K</span></p>
            </div>
        </div>
        ...
        <div class="tab-content" id="myTabContent">
            ...
            <div class="tab-pane fade" id="review" role="tabpanel" aria-labelledby="review-tab">
              ...
              <%
              	...
              	}else out.print("<p class=\"mb-20\">There are no reviews yet.</p>");
              %>
              </div>
