  ...
  <%@ include file="/Pages/MasterPage/Header.jsp" %>
    <div id="main-home">
        <div class="sw" style=" width: auto;">
            <form>
              ...
              <a href="#" class="logo" title="Tuulkit">
                <img src="/WebShop/style/assets/images/logoShop/LogoWebO.png" alt="">
              </a>
            </form>
          </div>
            ...
            <div class="slider">
                <div class="slideshow-container" >
                    ...
                    <div class="mySlides fade">
                      <img src="https://cf.shopee.vn/file/1927455215e171ecbe00553ab73d9cc6_xhdpi" style="width:100%">
                    </div>
                    
                    <div class="mySlides fade">
                      <img src="https://cf.shopee.vn/file/2cc53e9353fd62fc8812047a18993fed_xxhdpi" style="width:100%">
                    </div>
                    
                    <div class="mySlides fade">
                      <img src="https://cf.shopee.vn/file/540b60a7b4a328a1f12274e1904e1ec5_xxhdpi" style="width:100%">
                    </div>
        ...
        <div style="background-color: #FFFF;">
          <div style="padding: 10px; text-align: center; height: 48px;"><h1 style="color: #ee4d2d; font-size: 18px; font-weight: 700;">Sản Phẩm Được Mua Nhiều Nhất</h1></div>
            ...
            <div class="Product-hot">
              <a href="" >
                <div>
                  ...
                  <span class="spans"><p style="color: #FFFF; font-size: 14px; text-align: center;">Đã bán 11,1K</p></span>
                  <img src="https://cf.shopee.vn/file/fabe5d101de9ff01342f89a2f056aa12" alt="" ></div>
		  ...
		  <script type="text/javascript">
           $(document).on('ready', function () {
               $("<%= ".Shop"+shop.getId() %>").slick({
                   infinite: true,
                   slidesToShow: <%if(productList.size()<5) out.print(productList.size());else out.print(3);%>,
                   slidesToScroll: <%if(productList.size()<=3) out.print(2);else out.print(2);%>
               });});</script>	
        <div style="max-width: 100%; background-color: #FFFF; ">

            <div class="shop">
                <div class="header-shop">
                    <div style="border-radius: 50%;border: 2px solid #4444; margin: 10px;"><img src="<%=shop.getUrlAvatar()%>" alt="" style="width: 80px; border-radius: 50%;"></div>
                    <div><h1 style="font-size: 30px;"><%=shop.getNameShop()%></h1></div>
                    <div><button style="background-color: #FFFF; color: #ee4d2d; margin-left: 20px;">GHÉ THĂM <i class="fa fa-home" aria-hidden="true"></i></button></div>
                </div>
                <div style="width: 95%; height: 4px; background-color: #aaa!important;"></div>
            </div>
